...
public class MusicComposer {
    ...
    public static void compose() throws MidiUnavailableException, InterruptedException, IOException {
        ...
        int channel = 0, y = 0, position = 0, currentNote = 1, currentDuration = 200, lastChar = 11;
        int trackY = 4;
        int trackX = 75;
        boolean run = true;
        ...
        while (run) {
            ...
            switch (key.getKind()) {
                ...
                case Enter:
                    ...
                    break;
                case Insert:
                    edit(toArray(tracks[select].getName()), "tracks/" + tracks[select].getName());
                    break;
                default:
                    break;
            }
        ...
        while (run) {
            ...
            switch (key.getKind()) {
                ...
                case Enter:
                    ...
                    for (Note note : track) {
                        pw.println(Integer.toString(note.getNumber()));
                        pw.println(Integer.toString(note.getDuration()));
                    }
                    pw.close();
                    break;
                case Escape:
    ...
    public static ArrayList<Note> toArray(String filename) throws FileNotFoundException {
        ArrayList<Note> track = new ArrayList<>();
